    ...
    return (
        <main style={{ paddingTop: '120px', minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div className="container">
                <div className="cta-box" style={{ maxWidth: '450px', margin: '0 auto', padding: '3rem 2rem', textAlign: 'center' }}>
                    
                    {/* TELA 2: CONFIRMAÇÃO DO GOOGLE */}
                    {isGoogleConfirming ? (
                        <>
                            <h2 style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>Confirme seus Dados</h2>
                            <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '2rem' }}>
                                Quase lá! Revise como seu nome aparecerá para os outros pesquisadores.
                            </p>

                            {error && <div style={{ background: 'rgba(239, 68, 68, 0.1)', color: '#f87171', padding: '0.75rem', borderRadius: '8px', marginBottom: '1.5rem' }}>{error}</div>}
                            ...
                            <form onSubmit={handleConfirmGoogle} style={{ textAlign: 'left' }}>
                                <div className="form-group" style={{ marginBottom: '1.25rem' }}>
                                    ...
                                    <input type="email" className="form-input" value={googleAuthData?.email} disabled style={{ opacity: 0.7, cursor: 'not-allowed' }} />
                                </div>
                        ...
                        <>
                            ...
                            <div style={{ margin: '1.5rem 0', display: 'flex', alignItems: 'center', gap: '1rem' }}><div style={{ flex: 1, height: '1px', background: 'var(--border)' }}></div><span style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>OU</span><div style={{ flex: 1, height: '1px', background: 'var(--border)' }}></div></div>

                            <button onClick={handleGoogleSignIn} className="btn btn-secondary" style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '0.5rem' }} disabled={loading}>
                            ...
                            <p style={{ marginTop: '2rem', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
                                ...
                                <button onClick={() => setIsRegistering(!isRegistering)} style={{ background: 'none', border: 'none', color: 'var(--accent)', fontWeight: '600', cursor: 'pointer' }}>
